<template>
  <div>
    ...
    <EduModal @register="registerModal" @success="reload" />
  </div>
</template>
<script lang="ts" name="system-position" setup>
import { BasicTable, TableAction } from '/@/components/Table';
import { useModal } from '/@/components/Modal';
import { getPositionList, deletePosition, batchDeletePosition, customUpload, getExportUrl, getImportUrl } from './edu.api';
import { columns, searchFormSchema } from './edu.data';
import EduModal from './components/EduModal.vue';
import { useMessage } from '/@/hooks/web/useMessage';
import { useListPage } from '/@/hooks/system/useListPage';
const { createMessage } = useMessage();
const [registerModal, { openModal }] = useModal();
//createMessage.success('This is a success message!');
// 列表页面公共参数、方法
